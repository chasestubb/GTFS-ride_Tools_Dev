...
async function feed_creation(params){
    ...
    console.log(params)
    var fc_filename = Feed_Creation.Feed_Creation(params.agencies, params.routes, params.stops, params.trips, params.trips_per_route, params.start_date, params.end_date, params.feed_date, params.user_source, params.min_riders, params.max_riders, params.files, params.operation_days, params.calendar_type)
